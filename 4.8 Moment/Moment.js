...
function calculateDaysDifference(birthDate){
    ...
    let birthDate = moment('1978-07-03');
    calculateDaysDifference(birthDate);
    
    let birthDateForYearsMonthsDays = moment('1978-07-03');
    displayYearsMonthsDays(birthDateForYearsMonthsDays);
    
    let date1ForClosestDate = moment('1975-03-20');
    let date2ForClosestDate = moment('2020-07-15');
    displayClosestDate(date1ForClosestDate, date2ForClosestDate); 
    
    let date1ForComparison = moment('1985-07-30');
    let date2forComparison = moment('2023-03-18');
